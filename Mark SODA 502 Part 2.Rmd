...
*ggplot* has some limited ability to deal with geographic data. Here are the points from SWB plotted with an orthographic projection, using the ggplot *coord_map* and *borders* function.
...
```{r GEO_mean_center_source, warning=FALSE}
...
```{r GEO_mean_center_source_time, warning=FALSE}
...
```{r GEO_mean_center_type_time, warning=FALSE}
